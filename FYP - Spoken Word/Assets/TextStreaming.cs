...
{
    public class TextStreaming : MonoBehaviour
    {
        ...
        void AutofillFields()
        {
            _serviceUrl = "https://api.eu-gb.speech-to-text.watson.cloud.ibm.com/instances/6ea3ab50-9420-476c-a7bd-d7fefa31f4b3";

            ResultsField = GameObject.Find("Incoming Speech").GetComponent<TextMeshProUGUI>();

            _iamApikey = "pABoHA5QFyGO6ZCZpB9p96eEEQf5xMv3bkH5HvPfqODT";
